...
class config_tab : public child_tab {
private:
    ...
    std::int32_t selected_config_;

public:
    config_tab(void_* instance, input_owner* input_owner, 
               input_owner_overlay* overlay_owner, class _config* config_instance, const xstr& name);
